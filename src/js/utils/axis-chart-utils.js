...
export function getShortenedLabels(chartWidth, labels = [], isSeries = true, seriesLabelSpaceRatio = SERIES_LABEL_SPACE_RATIO) {
	let allowedSpace = (chartWidth / labels.length) * seriesLabelSpaceRatio;
